...
const MobileNavbar = ({ toggleMobileMenu, isMobileMenuOpen }) => {
  ...
  return (
    <section
      className={`fixed inset-0 flex flex-col items-center justify-start bg-primary-green text-white px-4 py-28 transform-gpu transition-transform duration-300 ease-in-out z-30 ${classes}`}>
